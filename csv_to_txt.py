...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_path', type=str, default=r"D:\work\project\DATA\Kaggle-uw/val_csv.csv")
    parser.add_argument('--num_per', type=float, default=1, help='The proportion of photos used')
    parser.add_argument('--train_per', type=float, default=1, help='The proportion of photos train')
